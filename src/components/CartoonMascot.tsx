  ...
  return (
    ...
    >
      <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-lg">
        {/* Antenna */}
        <line x1="50" y1="25" x2="50" y2="10" stroke="currentColor" strokeWidth="3" className="text-text-muted" />
        <circle cx="50" cy="8" r="4" fill="currentColor" className="text-gold" />
        
        {/* Head/Body */}
        <rect x="25" y="25" width="50" height="45" rx="16" fill="currentColor" className="text-foreground" stroke="currentColor" strokeWidth="2" strokeOpacity="0.1" />
        
        {/* Face Screen */}
        <rect x="32" y="32" width="36" height="24" rx="8" fill="currentColor" className="text-background" />
